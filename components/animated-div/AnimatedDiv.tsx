...
const AnimatedDiv: React.FC<AnimatedDivProps> = ({
  ...
  const [animatedClass, setAnimatedClass] = useState<string>(Animations.get(animation).before);
    ...
    <div
      ...
      onTransitionEnd={event => {
        if (
          ...
          window.getComputedStyle(event.currentTarget).getPropertyValue('opacity') === '0'
        ) {
